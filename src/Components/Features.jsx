    ...
    return(
        <section id="features">
            <div className="container h-auto py-12 bg-white flex flex-col items-center">
                <div className="content h-full w-full bg-[#f5f7fa] flex flex-col items-center pt-8 pb-10">
                    <h2 className="text-4xl font-bold text-black relative inline-block after:content-[''] after:absolute after:left-[10%] after:bottom-[-8px] after:w-[80%] after:h-1 after:bg-gradient-to-r after:from-blue-600 after:to-purple-600 mb-12">KEY FEATURES</h2>
