    ...
    return(
        ...
        <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-4 bg-opacity-50">
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white drop-shadow-lg text-center mb-2">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">TensorFleet</span>
                </h1>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white drop-shadow-lg text-center">
                    Supercharge Your AI Model Training
                </h2>
                <p className="text-sm md:text-base text-white mt-4 max-w-2xl text-center drop-shadow-xl opacity-100 font-medium tracking-wide shadow-white text-shadow-lg glow">
                ...
                <div className="mt-6">
                    <a href="#" className="uppercase text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-colors duration-300 rounded-3xl px-6 py-3 font-medium">Get Started</a>
                </div>
            </div>
        </div>
        </>
